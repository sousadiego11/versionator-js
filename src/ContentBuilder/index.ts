...
type BuildProps = { body: string, tag: string, issue: string, date: string, author: string }
...
const ContentBuilder =  {
    ...
    build({ body, tag, issue, date, author }: BuildProps) {
        ...
        const emoji = foundMatchEmoji ? emojis[foundMatchEmoji[1] as keyof typeof emojis] : ''
